...
export const CustomNavbar = () => {
  ...
  return (
    <nav className="w-full flex items-center py-4 px-4 sm:py-6 sm:px-8 fixed top-0 z-50 bg-gradient-to-br from-gray-900 via-black to-gray-900">
  {/* Mobile: Hamburger left, socials and connect right */}
